    ...
    <div className="filter-content">
      ...
      <div className="multi-select-filter-container">
        <div className={`value-container${chips?.length ? ' chip-container' : ''}`}>
          {
            chips?.length ?
                  chips.map((role) => {
                    return <Chips text={role} handleDelete={handleDelete}/>
                  }) :
        ...
        <div className="dropdown-arrow-container">
          <svg height="20" width="20" viewBox="0 0 20 20" aria-hidden="true" focusable="false" class="css-8mmkcg dropdown-toggle" onClick={handleDropdown}>
